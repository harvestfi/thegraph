...
import {
  NoMintPoolContract
} from "../../generated/NoMintNotifyHelperListener/NoMintPoolContract"
...
): Pool
{
  ...
  if (pool == null){
    ...
    // some specific pools don't have a vault such as farm/weth farm/grain farm/usdc
    ...
    pool.rewardTokens = [reward_token.id]
    pool.save()
